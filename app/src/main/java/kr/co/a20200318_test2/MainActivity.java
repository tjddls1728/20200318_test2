...
public class MainActivity extends baseActivity {
    ...
    private void addRooms() {
        ...
        roomDatas.add(new Room(18000,"서울시 노원구", 4 , "노원구의 투룸"));
        roomDatas.add(new Room(28000,"서울시 종로구", 4 , "종로구입니다"));
        roomDatas.add(new Room(38000,"서울시 중랑구", 4 , "2층집 입니다"));
        roomDatas.add(new Room(48000,"서울시 강북구", 4 , "편의시설이 좋습니다"));
